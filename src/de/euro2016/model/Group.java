...
@NamedQuery(name = Group.select, query = "Select c From Gruppe c order by c.kennzeichen")
@Entity(name = "Gruppe")
public class Group implements Serializable {

	private static final long serialVersionUID = -5529994540448820088L;

	public static final String select = "SelectGroups";
	...
	public Group(final Character c) {
		this.kennzeichen = c;
	}
